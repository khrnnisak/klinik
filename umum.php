...
<body>
  ...
  <h2 class="text-center">Jadwal Dokter Umum</h2>
      ...
      <div class="modal-body">
        <form id="addUser" action="add_user.php">
          ...
          <div class="text-center">
            <button type="submit" class="btn btn-primary" name="submit" value="submit" onclick = "konfirmasi()">Submit</button>
            <script>
                function konfirmasi(){
                  var tanya = confirm("Apakah data yang dimasukkan sudah benar ?");
          
                  if(tanya === true) {
                      window.location = "noantrian.php";
                  }else{
                      window.location = "tht.php";
                  }
